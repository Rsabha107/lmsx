...
return [
    ...
    |
    | Anthropic has no image, audio, or embedding endpoints, so those fall back
    | to a provider that does - set the matching env var (and that provider's
    | API key) before using one of those capabilities.
    |
    */
